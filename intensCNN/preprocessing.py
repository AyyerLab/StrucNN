...
def load_data():
    ...
    with h5py.File('/home/mallabhi/SPIEncoder/data/sim_MS2.h5', 'r') as f:
        intens = f['image'][:5000, :,:]
        orientation = f['quaternion'][:5000,:]
        objsize = f['size'][:5000]
    ...
    '''Normalizing Intensity vals to range: 0-0.1'''
    sz = intens.shape[1]
    ...
    '''Normalizing Objsize vals to range: 0-1'''
